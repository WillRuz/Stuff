    ...
    public class InfantFrame extends JFrame
    {
        ...
        public class DataPanel extends JPanel
        {
            ...
            public void setTime(int newTime)
            {
                ...
                {
                    // if the time is > 0, should have a valid trial
                    if(newTime >= 0 && newTime < InfantFrame.this.trial.getSize())
                    {
                        this.currentTime = newTime;
                        this.timeSlider.setValue(newTime);
                        
                        // Get the state, and call update
                        State state = trial.getItem(newTime);
                        update(state);
                    }
                    
                    // if it aint a good trial
                    else
                    {
                        //turn the timer off
                        DataPanel.this.runButton.setText("Start");
            ...
            public KinematicPointAbstract createKinematicModel()
            {
                ...
                // The hip, and back is a Constant
                KinematicPointConstant root = new KinematicPointConstant(blue, LINE_WIDTH, 0.0, 0.0, 0.0);
                KinematicPointConstant lowerBack = new KinematicPointConstant(red, LINE_WIDTH, 0.1, 0.0, 0.0);
                KinematicPointConstant leftHip = new KinematicPointConstant(blue, LINE_WIDTH, 0.0, 0.5, 0.0);
                KinematicPointConstant rightHip = new KinematicPointConstant(blue, LINE_WIDTH, 0.0, -0.5, 0.0);
                // add it to the Panel
                ...
                // Left leg
                KinematicPointState leftKnee = new KinematicPointState(red, LINE_WIDTH, "left_knee");
                KinematicPointState leftAnkle = new KinematicPointState(blue, LINE_WIDTH, "left_ankle");
                KinematicPointState leftFoot = new KinematicPointState(red, LINE_WIDTH, "left_foot");
                leftHip.addChild(leftKnee);
                leftHip.addChild(leftAnkle);
                leftHip.addChild(leftFoot);

                // Right leg
                KinematicPointState rightKnee = new KinematicPointState(red, LINE_WIDTH, "right_knee");
                KinematicPointState rightAnkle = new KinematicPointState(blue, LINE_WIDTH, "right_ankle");
                KinematicPointState rightFoot = new KinematicPointState(red, LINE_WIDTH, "right_foot");
                rightHip.addChild(rightFoot);
                rightHip.addChild(rightKnee);
                rightHip.addChild(rightAnkle);

                // Back
                KinematicPointState upperBack = new KinematicPointState(red, LINE_WIDTH, "upper_back");
                lowerBack.addChild(upperBack);
                
                // Left Arm
                KinematicPointState leftShoulder = new KinematicPointState(blue, LINE_WIDTH, "left_shoulder");
                KinematicPointState leftElbow = new KinematicPointState(red, LINE_WIDTH, "left_elbow");
                KinematicPointState leftWrist = new KinematicPointState(blue, LINE_WIDTH, "left_wrist");
                upperBack.addChild(leftShoulder);
                leftShoulder.addChild(leftElbow);
                leftElbow.addChild(leftWrist);
                
                // Right Arm
                KinematicPointState rightShoulder = new KinematicPointState(blue, LINE_WIDTH, "right_shoulder");
                KinematicPointState rightElbow = new KinematicPointState(red, LINE_WIDTH, "right_elbow");
                KinematicPointState rightWrist = new KinematicPointState(blue, LINE_WIDTH, "right_wrist");
            ...
            {
                // Update all the panels with a new state
                topViewPanel.setState(state);
                sideViewPanel.setState(state);
                rearViewPanel.setState(state);
                infantTextField.setText("Infant: " + infant.getInfantID());
